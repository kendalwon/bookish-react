    ...
    <div>
      <section class="main">
        <ul class="articleList" >
            ...
            <li class="articleItem">
              <h1 class="articleTitle">How to start teaching your child to read</h1>
              <p class="articleDate">February 14, 2019</p>
              <p class="articleContent">So you think your child is ready to learn to read, but you’re not sure where to start? I taught my kids to read at home and without much fuss. First, wait until your child is interested in reading and able to concentrate for more than a few minutes. When this seems to be the case, it’s time to make sure your child knows all the letter in uppercase and lowercase. Puzzles and matching games make this review fun for kids.<br /><br />
              ...
              I like to start with Bob Books, <a class="contentLink" href="https://www.amazon.com/Complete-Set-Books-Sets-books/dp/B001KIZMEU" target="_blank" rel="noopener noreferrer">found here</a>, as they’re simple and short and give kids a sense of accomplishment when they finish. Soon, your child will be ready for more interesting titles. Make sure you keep your bookshelves stocked with whatever he’s interested in to encourage him to keep reading!
            </p>
          </li>
        </ul>
      </section>
      <section class="archive">
        <h1 class="archiveHeading">more articles</h1>
        <ul class="archiveList">
          <li class="archiveItem">
            <a href="." class="archiveLink">The million-word gap</a>
            <p class="archiveDate">July 17, 2018</p></li>
          <li class="archiveItem">
            <a href="." class="archiveLink">Best books for babies</a>
            <p class="archiveDate">November 21, 2018</p></li>
          <li class="archiveItem">
            <a href="." class="archiveLink">Literacy games to play in the car</a>
            <p class="archiveDate">July 31, 2018</p></li>
          <li class="archiveItem">
            <a href="." class=" archiveLink">Interactive books your kids will love</a>
            <p class="archiveDate">October 22, 2017</p></li>
        </ul>
      </section>
    </div>
  );
